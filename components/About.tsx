  ...
  return (
    <div className="section pt-20 md:pt-24 ">
      ...
      <svg
        ...
        viewBox="0 0 239 726"
        className=" left-[-50px] xl:left-12 xl:top-48 z-0 w-[238px] h-[726px] absolute text-heading dark:text-dark-heading opacity-10"
      >
        <g fill="currentColor" clipPath="url(#clip0_56_1800)">
        ...
        <defs>
          <clipPath id="clip0_56_1800">
            <path fill="currentColor" d="M0 0H238.5V725.35H0z"></path>
          </clipPath>
        </defs>
      </svg>
    </div>
